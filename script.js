// ================================================================
        ...
        function initQRCodeModals() {
            ...
            // "How to Scan" popup using SweetAlert2
        ...
        function initVideoModal() {
            ...
            // Also handle the video modal close when the video ends (optional)
            video.addEventListener('ended', function() {
                // Do not auto-close, user should close manually
            });
        }
        ...
        function initAll() {
            ...
            initImagePreviews();
            initQRCodeModals();
            initVideoModal(); // FIXED: video modal close now works
            initContactForm();
            initNewsletter();
            initResumeDownload();
